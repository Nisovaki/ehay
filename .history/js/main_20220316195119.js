$(document).ready(function () {
  ...
  menuButton.addEventListener('click', function () {
    document.querySelector(".navbar-top").classList.toggle('navbar-top__block--mobile_visible');
  });
  ...
  const swiperPrev = document.getElementById("card__button-prev");
  const swiperNext = document.getElementById("card__button-next");
  ...
  const swiperPrevTwo = document.getElementById("unreleased-button-prev");
  const swiperNextTwo = document.getElementById("unreleased-button-next");
  ...
  cardSwiper.on("reachEnd", function () {
    $(".card-button-next").addClass("card-button-next--hidden");
  });

  cardSwiper.on("reachBeginning", function () {
    $(".card-button-prev").addClass("card-button--prev--hidden");
  });

  cardSwiper.on("fromEdge", function () {
    $(".card-button-next").removeClass("card-button--next--hidden");
    $(".card-button-prev").removeClass("card-button--prev--hidden");
  });

  
  unreleasedSwiper.on("reachEnd", function () {
    $(".unreleased__button--next").addClass("unreleased__button--next--hidden");
  });

  unreleasedSwiper.on("reachBeginning", function () {
    $(".unreleased__button--prev").addClass("unreleased__button--prev--hidden");
  });

  unreleasedSwiper.on("fromEdge", function () {
    $(".unreleased__button--next").removeClass("unreleased__button--next--hidden");
    $(".unreleased__button--prev").removeClass("unreleased__button--prev--hidden");
  });
