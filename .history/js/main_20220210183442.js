...
$(document).ready(function () {
  ...
  reviewsSlider.on("reachEnd", function () {
    $(".unreleased-button__next").addClass("unreleased-button-next--hidden");
  });
  reviewsSlider.on("reachBeginning", function () {
    $(".unreleased-button__prev").addClass("unreleased-button-prev--hidden");
  });
  reviewsSlider.on("fromEdge", function () {
    $(".unreleased-button__next").removeClass("unreleased-button-next--hidden");
    $(".unreleased-button__prev").removeClass("unreleased-button-prev--hidden");
  });
