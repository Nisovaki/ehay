$(document).ready(function () {
  ...
  const swiperPrev = document.getElementById("unreleased__button--prev");
  const swiperNext = document.getElementById("unreleased__button--next");

  swiperPrev.addEventListener("click", () => {
    unreleasedSlider.slidePrev();
  });
  swiperNext.addEventListener("click", () => {
    unreleasedSlider.slideNext();
  });
