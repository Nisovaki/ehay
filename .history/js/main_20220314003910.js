$(document).ready(function () {
  ...
  mark.addEventListener("click", function () {
    document.getElementById("markIcon").classList.toggle("mark--active");
  });

  var mark = document.getElementById("markIcon2");
  mark.addEventListener("click", function () {
    document.getElementById("markIcon2").classList.toggle("mark--active");
  });

  var mark = document.getElementById("markIcon3");
  mark.addEventListener("click", function () {
    document.getElementById("markIcon3").classList.toggle("mark--active");
  });
});